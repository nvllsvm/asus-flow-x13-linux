...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    External (_SB_.NPCF.ADBP, IntObj)
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xEC315000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xEC319000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xEC555C98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xEC555998, 0x0C)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xEC543000, 0x0100)
    ...
    Scope (_SB)
    {
        ...
        Name (LEDS, Zero)
        Name (FNIV, Zero)
        Name (AATP, Buffer (0x02)
        {
             0x00, 0x00                                       // ..
        })
        Name (AALT, Buffer (0x02)
        {
             0x00, 0x00                                       // ..
        })
        Name (ACPT, Zero)
                ...
                If ((Local0 == 0x53564544))
                {
                    ...
                    If ((IIA0 == 0x00090019))
                    {
                        ...
                        If ((IIA1 == Zero))
                        {
                            EGIF [Zero] = 0x0A
                            GPUM = One
                            Local7 = (^^NPCF.ADBP & 0xFFFF)
                            If ((Local7 < 0x0100))
                            {
                                Local7 >>= 0x04
                            }

                            ^^NPCF.ADBP &= 0x00FF0000
                            ^^NPCF.ADBP |= Local7
                            AATP [Zero] = Local7
                            AATP [One] = Zero
                        }
            ...
            Device (PRT4)
            {
                ...
                Device (DCAM)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        Return (XPLD) /* \_SB_.PCI0.GP17.XHC1.RHUB.PRT4.DCAM._PLD.XPLD */
                    }
                }
            }
    ...
    Scope (_SB.PCI0.GPP4.WLAN)
    {
        ...
        If ((VIDS == 0x14C3))
        {
            ...
            Method (MTDS, 0, Serialized)
            {
                ...
                EWR2 [0x0D] = ST15 /* \_SB_.ST15 */
                EWR2 [0x0E] = ST16 /* \_SB_.ST16 */
                EWR2 [0x0F] = ST17 /* \_SB_.ST17 */
                EWR2 [0x10] = ST18 /* \_SB_.ST18 */
                EWR2 [0x11] = ST19 /* \_SB_.ST19 */
